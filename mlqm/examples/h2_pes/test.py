...
plt.plot(v_PES,results['SCF'],'y-',label='SCF PES')
plt.plot(v_PES,results['Predtype'], 'r--',label='MP2 PES')
plt.plot(v_PES,results['Validations'],'b-o',label='{} PES'.format('CCSD'),linewidth=3)
plt.plot(v_PES,results['Predictions'],'r-^',ms=2,label='{}/ML-{} PES'.format('MP2',a.M),linewidth=2)
